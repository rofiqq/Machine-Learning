...
all_features = datasets(filename = 'boston.csv')
...
used_features['minimum_nights'] = np.log10(used_features['minimum_nights'])
used_features['number_of_reviews'] = np.log10(used_features['number_of_reviews'])
idx_inf = np.argwhere(np.isinf(used_features['number_of_reviews']))
used_features['number_of_reviews'][idx_inf] = 0.

used_features['price'] = np.log10(used_features['price'])
idx_inf = np.argwhere(np.isinf(used_features['price']))
used_features['price'][idx_inf] = 0.
